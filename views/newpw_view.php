...
<div class="container-fluid-full">
	<div class="row-fluid">
		<div class="login-box">
			<br>
			<h2>Carteira Tesouro Direto - Alteração de Senha</h2>
			<div class="row-fluid sortable">
				<div class="alert alert-danger <?php echo !empty($erro) ? '' : 'hidden' ?>">
          			<?php echo $erro; ?>
        		</div>
        	</div> 
			<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/account/changepw" method="post">
				...
				<fieldset>
					...
					<div class="input-prepend" title="Senha">
						<span class="add-on"><i class="halflings-icon lock"></i></span>
						<input class="input-large span10" type="password" class="input" name="confirmar_senha" id="confirmar_senha" placeholder="confirmar senha"  required>
					</div>
