<?php echo form_open_multipart('titulos/adicionar_post', array( 'class' => 'form-horizontal', 'onsubmit' => "$(this).ajaxSubmit({dataType : 'json', success: processModalSubmit}); return false;")); ?>
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">Adicionar título</h4>
        </div>
            ...
            <div class="row-fluid sortable">
                <div class="col-lg-6">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" id="sigla" name="sigla" class="input"> 
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input datepicker" name="dt_ult_alteracao" id="dt_ult_alteracao" value="<?php echo date("d/m/Y H:i");?>">
                        </div>
                    </div>
