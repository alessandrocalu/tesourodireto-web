<?php echo form_open_multipart('carteira/adicionar_post', array( 'class' => 'form-horizontal', 'onsubmit' => "$(this).ajaxSubmit({dataType : 'json', success: processModalSubmit}); return false;")); ?>
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">Adicionar registro de compra de Título</h4>
        </div>
            ...
            <div class="row-fluid sortable">
                <div class="col-lg-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php foreach ($titutos as $titulo) { ?>
                                <option value="<?php echo $titulo["id"]; ?>"><?php echo $titulo["nome"]; ?></option>
                            <?php  } ?>    
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input datepicker" name="dt_compra" id="dt_compra" value="<?php echo date("d/m/Y");?>" required>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="prependedInput" name="quantidade" id="quantidade" min="0" max="100000" size="10" type="number" step="any" required>
                        </div>    
                    </div>
                    ...
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            ...
                            <input id="preco_compra" name="preco_compra" min="0" max="100000" size="10" type="number" step="any" required>
                        </div>    
                    </div>
                    ...
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            ...
                            <input id="prependedInput" name="tx_pactuada" id="tx_pactuada" min="0" max="100" size="5" type="number" step="any">
                        </div>    
                    </div>
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            <span class="add-on">%</span>
                            <input id="prependedInput" name="tx_bvmf" id="tx_bvmf" min="0" max="100" size="5" type="number" step="any">
                        </div>    
                    </div>
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            <span class="add-on">%</span>
                            <input id="prependedInput" name="tx_corretora" id="tx_corretora" min="0" max="100" size="5" type="number" step="any">
                        </div>    
                    </div>
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            <span class="add-on">%</span>
                            <input id="prependedInput" name="tx_iof" id="tx_iof" min="0" max="100" size="5" type="number" step="any">
                        </div>    
                    </div>
                    <div class="input-prepend">
                        ...
                        <div class="controls">
                            <span class="add-on">%</span>
                            <input id="prependedInput" name="tx_ir" id="tx_ir" min="0" max="100" size="5" type="number" step="any">
                        </div>    
                    </div>
                </div>
                <!-- /.col-lg-6 (nested) -->
