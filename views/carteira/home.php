            ...
            <div class="row-fluid">                
                ...
                <div class="span3 statbox blue noMargin" ontablet="span6" ondesktop="span3">
                    <div class="number"><?php echo ($total_venda<$total_comprado?'-':'').number_format((($total_venda-$total_comprado)/$total_comprado)*100,2,',','.').'&nbsp;'; ?><i class="<?php echo ($total_venda<$total_comprado?'icon-arrow-down':'icon-arrow-up'); ?>"></i></div>
                        ...
                        ?>
                            ...
                            <li><h2><?php echo $atual["sigla"];?></h2><br>
                                <p><?php echo $atual["nome"];?>
                                    <br>&nbsp;&raquo;Valor na Compra(R$)&nbsp;
                                        <b>
                                            <?php echo number_format($atual["comprado"],2,',','.'); ?>
                                        </b>
                                    <br>&nbsp;&raquo;Lucro/Prejuízo(%)&nbsp;
                                        <b>
                                            <?php echo ($atual["compra"]<$atual["comprado"]?'-':'').number_format(($atual["compra"]-$atual["comprado"]/$atual["comprado"])*100,2,',','.'); ?>
                                        </b>
                                    <br>&nbsp;&raquo;Proficiência(R$)&nbsp;
                                        <b>
                                            <?php echo ($atual["compra"]<$atual["comprado"]?'-':'').number_format(($atual["compra"]-$atual["comprado"]),2,',','.'); ?>
                                        </b> 
                                    <br>&nbsp;&raquo;Montante Proficiência(R$)&nbsp;
                                        <b>
                                            <?php echo ($atual["compra"]<$atual["comprado"]?'-':'').number_format(($atual["compra"]-$atual["comprado"])*$atual["quantidade"],2,',','.'); ?>
                                        </b>        
                                    <br>&nbsp;Compra(R$)&nbsp;
                                        <b>
                                            <?php echo number_format($atual["compra"],2,',','.'); ?>
                                        </b>
                                    &nbsp;Venda(R$)&nbsp;
                                        <b>
                                            <?php echo number_format($atual["venda"],2,',','.'); ?>
                                        </b>
                                    </p>
                            </li>
